    ...
    <PageWrapper>
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-lg max-w-none text-foreground/70">
          ...
          <h2 className="text-2xl font-bold text-foreground mt-8 mb-4">3. Information We Do NOT Collect</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-foreground mt-8 mb-4">4. How We Use Information</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-foreground mt-8 mb-4">5. Blockchain Transparency</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-foreground mt-8 mb-4">6. Third-Party Services</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-foreground mt-8 mb-4">11. Contact</h2>
          <p>
