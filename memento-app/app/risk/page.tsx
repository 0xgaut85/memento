  ...
  return (
    <PageWrapper>
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl md:text-5xl font-black tracking-tighter mb-4">Risk Disclosure</h1>
        ...
        <div className="prose prose-lg max-w-none text-foreground/70">
          ...
          <h2 className="text-2xl font-bold text-foreground mt-8 mb-4">1. General Investment Risks</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-foreground mt-8 mb-4">2. Smart Contract Risks</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-foreground mt-8 mb-4">3. Strategy-Specific Risks</h2>
          
          <h3 className="text-xl font-bold text-foreground mt-6 mb-3">Dividend Delta-Neutral Strategy</h3>
          <ul className="list-disc pl-6 space-y-2">
          ...
          <h3 className="text-xl font-bold text-foreground mt-6 mb-3">Funding Rate Arbitrage</h3>
          <ul className="list-disc pl-6 space-y-2">
          ...
          <h3 className="text-xl font-bold text-foreground mt-6 mb-3">REITs / Income Strategy</h3>
          <ul className="list-disc pl-6 space-y-2">
          ...
          <h2 className="text-2xl font-bold text-foreground mt-8 mb-4">4. Liquidity Risks</h2>
          <ul className="list-disc pl-6 space-y-2">
          ...
          <h2 className="text-2xl font-bold text-foreground mt-8 mb-4">5. Regulatory Risks</h2>
          <ul className="list-disc pl-6 space-y-2">
          ...
          <h2 className="text-2xl font-bold text-foreground mt-8 mb-4">6. Technology Risks</h2>
          <ul className="list-disc pl-6 space-y-2">
          ...
          <h2 className="text-2xl font-bold text-foreground mt-8 mb-4">7. No Insurance</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-foreground mt-8 mb-4">8. Do Your Own Research</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-foreground mt-8 mb-4">9. Acknowledgment</h2>
          <p>
