    ...
    <PageWrapper>
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-lg max-w-none text-foreground/70">
          ...
          <h2 className="text-2xl font-bold text-foreground mt-8 mb-4">3. Nature of the Protocol</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-foreground mt-8 mb-4">4. Risks</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-foreground mt-8 mb-4">5. Fees</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-foreground mt-8 mb-4">6. No Financial Advice</h2>
          <p>
